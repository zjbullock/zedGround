    ...
    this.projects = [
      {
        ...
        + "It was designed to fetch the price of milk from a certain unnamed super store's site, format it as a message, then text him.<br>"
        + "It was a fun Golang project that took entirely too much effort.  The service even had the ability to use cookies to get milk prices from the unnamed site's website by zip code!"
        ...
        + "Eventually, the unnamed site seemed to have blocked calls to their endpoint that provided the location cookies by my server, so I decided to shut it down.  All good things must come to an end I suppose."
      },
      {
        ...
        + "Flutter is a lot of fun to use and makes developing for iOS and Android very easy.  I hope to make another Flutter app in the future."
      },
      {
        ...
        + "This project taught me about using the DOM and thinking about how my code affected the user interface, rather than the data that is passed around.<br>"
      ...
      },
      {
        ...
        + "It is currently deployed to GCP App Engine, and will generate insults with a single verb, adjective, and noun.  It has approximately 40 adjectives, 40 nouns, and 15 verbs to select from at random and 5 different sentence patterns."
      }
    ];
  }
